...
class BwuColumnPicker extends PolymerElement with ChangeNotifier  {
  ...
  @reflectable @observable List<CbData> get columnCheckboxes => __$columnCheckboxes; List<CbData> __$columnCheckboxes = toObservable(<CbData>[]); @reflectable set columnCheckboxes(List<CbData> value) { __$columnCheckboxes = notifyPropertyChange(#columnCheckboxes, __$columnCheckboxes, value); }
  @reflectable @observable bool get isSyncResize => __$isSyncResize; bool __$isSyncResize = false; @reflectable set isSyncResize(bool value) { __$isSyncResize = notifyPropertyChange(#isSyncResize, __$isSyncResize, value); }
  @reflectable @observable bool get isAutoResize => __$isAutoResize; bool __$isAutoResize = false; @reflectable set isAutoResize(bool value) { __$isAutoResize = notifyPropertyChange(#isAutoResize, __$isAutoResize, value); }
